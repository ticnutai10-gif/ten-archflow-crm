...
const FunctionDisplay = ({ toolCall }) => {
    ...
    const statusConfig = {
        ...
        running: { icon: Loader2, color: 'text-slate-500', text: 'מריץ...', spin: true },
        in_progress: { icon: Loader2, color: 'text-slate-500', text: 'מריץ...', spin: true },
        completed: isError ? 
        ...
        <div className="mt-2 text-xs">
            ...
            >
                ...
                {!statusConfig.spin && (toolCall.arguments_string || results) && (
                    <ChevronRight className={cn("h-3 w-3 text-slate-400 transition-transform mr-auto", 
                        expanded && "rotate-90")} />
                )}
            </button>
...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mt-0.5 shadow-lg">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-gradient-to-br from-blue-600 to-purple-600 text-white shadow-lg" : "bg-white border border-slate-200 shadow-sm"
                    )}>
                        {isUser ? (
