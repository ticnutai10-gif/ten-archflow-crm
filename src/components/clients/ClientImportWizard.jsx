  ...
  const validateData = () => {
    ...
    rawRows.forEach((row, rowIndex) => {
      ...
      if (!client.name || !client.name.trim()) {
        errors.push({ row: rowIndex + 2, error: 'חסר שם לקוח (שדה חובה)' });
        return;
      }
      ...
      <DialogContent className="max-w-6xl max-h-[95vh] overflow-hidden" dir="rtl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-2xl">
            ...
            מערכת יבוא לקוחות מתקדמת
          </DialogTitle>
          <DialogDescription>
            יבוא חכם ומתקדם של לקוחות מקבצי Excel ו-CSV עם תמיכה מלאה בעברית
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="text-center py-12">
              ...
              >
                <div className="border-4 border-dashed border-blue-300 rounded-2xl p-16 bg-gradient-to-br from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all">
                  ...
                  <p className="text-slate-600 mb-6">תומך ב-Excel (.xlsx, .xls) ו-CSV</p>
                  <div className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all">
            ...
            <div>
              <div className="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-green-700">לקוחות תקינים</div>
                  </div>
                  <div className="text-center">
              ...
              <div className="flex gap-3">
                ...
                >
                  ...
                  ייבא {validatedData.length} לקוחות
                </Button>
              </div>
            </div>
          )}
                    ...
                    <ScrollArea className="h-32">
                      <div className="text-sm text-red-800 space-y-1 text-right">
                        {importResults.failedRows.map((fail, i) => (
                          <div key={i}>
                            שורה {fail.row} ({fail.name}): {fail.error}
                          </div>
                        ))}
                      </div>
                    </ScrollArea>
